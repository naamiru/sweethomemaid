...
const PIECE_FOR_INDEX: Array<Piece | [Piece, Cell]> = [
  ...
  createPiece(Kind.Aqua, 0, 0, 4),
  createPiece(Kind.Aqua, 0, 0, 5),
  createPiece(Kind.Aqua, 0, 0, 6),
  ...
  createPiece(Kind.Blue, 0, 0, 4),
  createPiece(Kind.Blue, 0, 0, 5),
  createPiece(Kind.Blue, 0, 0, 6),
  createPiece(Kind.Bomb, 0, 1),
  createPiece(Kind.Bomb, 0, 2),
  createPiece(Kind.Bomb, 0, 3),
  createPiece(Kind.Bomb, 0, 0, 1),
  createPiece(Kind.Bomb, 0, 0, 2),
  createPiece(Kind.Bomb, 0, 0, 3),
  [createPiece(Kind.Bomb), createCell(1)],
  [createPiece(Kind.Bomb), createCell(2)],
  [createPiece(Kind.Bomb), createCell(3)],
  [createPiece(Kind.Bomb), createCell(4)],
  [createPiece(Kind.Bomb), createCell(5)],
  [createPiece(Kind.Bomb), createCell(6)],
  [createPiece(Kind.Bomb), createCell(7)],
  [createPiece(Kind.Bomb), createCell(8)],
  [createPiece(Kind.Bomb), createCell(9)],
  ...
  createPiece({ kind: Kind.Button, count: 4 }),
  createPiece({ kind: Kind.Button, count: 5 }),
  createPiece({ kind: Kind.Button, count: 6 }),
  createPiece(Kind.Cat),
  createPiece(Kind.Chick),
  createPiece({ kind: Kind.Danbooru, count: 1 }),
  createPiece({ kind: Kind.Danbooru, count: 10 }),
  createPiece({ kind: Kind.Danbooru, count: 11 }),
  createPiece({ kind: Kind.Danbooru, count: 12 }),
  createPiece({ kind: Kind.Danbooru, count: 2 }),
  createPiece({ kind: Kind.Danbooru, count: 3 }),
  createPiece({ kind: Kind.Danbooru, count: 4 }),
  createPiece({ kind: Kind.Danbooru, count: 5 }),
  createPiece({ kind: Kind.Danbooru, count: 6 }),
  createPiece({ kind: Kind.Danbooru, count: 7 }),
  createPiece({ kind: Kind.Danbooru, count: 8 }),
  createPiece({ kind: Kind.Danbooru, count: 9 }),
  createPiece({ kind: Kind.Egg, count: 1 }),
  createPiece({ kind: Kind.Egg, count: 2 }),
  ...
  createPiece(Kind.Green, 0, 0, 4),
  createPiece(Kind.Green, 0, 0, 5),
  createPiece(Kind.Green, 0, 0, 6),
  ...
  createPiece(Kind.Missile, 0, 1),
  createPiece(Kind.Missile, 0, 2),
  createPiece(Kind.Missile, 0, 3),
  createPiece(Kind.Missile, 0, 0, 1),
  createPiece(Kind.Missile, 0, 0, 2),
  createPiece(Kind.Missile, 0, 0, 3),
  createPiece(Kind.Missile, 0, 0, 4),
  createPiece(Kind.Missile, 0, 0, 5),
  createPiece(Kind.Missile, 0, 0, 6),
  createPiece(Kind.Missile, 0, 0, 7),
  createPiece(Kind.Missile, 0, 0, 8),
  createPiece(Kind.Missile, 0, 0, 9),
  ...
  createPiece(Kind.Special, 0, 1),
  createPiece(Kind.Special, 0, 2),
  createPiece(Kind.Special, 0, 3),
  createPiece(Kind.Special, 0, 0, 1),
  createPiece(Kind.Special, 0, 0, 2),
  createPiece(Kind.Special, 0, 0, 3),
  createPiece(Kind.Special, 0, 0, 4),
  createPiece(Kind.Special, 0, 0, 5),
  createPiece(Kind.Special, 0, 0, 6),
  createPiece(Kind.Special, 0, 0, 7),
  createPiece(Kind.Special, 0, 0, 8),
  createPiece(Kind.Special, 0, 0, 9),
  ...
  createPiece(Kind.Pink, 0, 0, 4),
  createPiece(Kind.Pink, 0, 0, 5),
  createPiece(Kind.Pink, 0, 0, 6),
  ...
  createPiece({ kind: Kind.Peanut, count: 1 }),
  createPiece({ kind: Kind.Peanut, count: 2 }),
  createPiece({ kind: Kind.Peanut, count: 3 }),
  ...
  createPiece(Kind.HRocket, 0, 1),
  createPiece(Kind.HRocket, 0, 2),
  createPiece(Kind.HRocket, 0, 3),
  createPiece(Kind.HRocket, 0, 0, 1),
  createPiece(Kind.HRocket, 0, 0, 2),
  createPiece(Kind.HRocket, 0, 0, 3),
  createPiece(Kind.HRocket, 0, 0, 4),
  createPiece(Kind.HRocket, 0, 0, 5),
  createPiece(Kind.HRocket, 0, 0, 6),
  createPiece(Kind.HRocket, 0, 0, 7),
  createPiece(Kind.HRocket, 0, 0, 8),
  createPiece(Kind.HRocket, 0, 0, 9),
  ...
  createPiece(Kind.VRocket, 0, 1),
  createPiece(Kind.VRocket, 0, 2),
  createPiece(Kind.VRocket, 0, 3),
  createPiece(Kind.VRocket, 0, 0, 1),
  createPiece(Kind.VRocket, 0, 0, 2),
  createPiece(Kind.VRocket, 0, 0, 3),
  [createPiece(Kind.VRocket), createCell(1)],
  [createPiece(Kind.VRocket), createCell(2)],
  [createPiece(Kind.VRocket), createCell(3)],
  [createPiece(Kind.VRocket), createCell(4)],
  [createPiece(Kind.VRocket), createCell(5)],
  [createPiece(Kind.VRocket), createCell(6)],
  [createPiece(Kind.VRocket), createCell(7)],
  [createPiece(Kind.VRocket), createCell(8)],
  [createPiece(Kind.VRocket), createCell(9)],
